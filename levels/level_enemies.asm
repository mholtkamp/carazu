...
PLATFORM_DEF_SPEED EQU $0200 >> 3 

	SECTION "LevelEnemies", DATA, BANK[1]
	
Level0Enemies:
	DB ENEMY_SLIME, 39, 15, 37, 40, SLIME_DEF_XVEL, 0, 0 
	DB ENEMY_SPIKE, 42, 23, 23, 28, SPIKE_DEFAULT_CHASE_SPEED, SPIKE_FLAG_VERTICAL | SPIKE_FLAG_BLACK
...
Level2Enemies:
	DB ENEMY_PLATFORM, 16, 91, 91, 97, PLATFORM_DEF_SPEED, PLATFORM_FLAG_WAIT | PLATFORM_FLAG_VERTICAL
